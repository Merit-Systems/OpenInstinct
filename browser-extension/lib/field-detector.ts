...
const fieldPatterns: readonly {
  ...
  {
    kind: "postal-address",
    pattern: /address\s*(?:line)?\s*2|apartment|apt|suite|unit/u,
    token: "address-line2",
  },
  {
    kind: "postal-address",
    pattern: /street\s*address/u,
    token: "street-address",
  },
  {
    kind: "postal-address",
    pattern: /address\s*(?:line)?\s*1/u,
    token: "address-line1",
  },
  {
    kind: "postal-address",
    pattern: /city|locality/u,
    token: "address-level2",
  },
  {
    kind: "postal-address",
    pattern: /state|province|region/u,
