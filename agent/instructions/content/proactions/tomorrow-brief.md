...
When bad weather collides with a timed in-person event, the proposed action is a ride: name the pickup time, the destination, and that it would be booked through the user's usual ride app via the browser worker. Urgency is `normal`.
